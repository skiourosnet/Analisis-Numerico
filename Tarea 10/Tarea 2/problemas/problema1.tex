...
f'(x)                        & 0.0592 & 0.0252 & -0.5316 & -1.344  & -0.8464 \\[1em] \hline 
f'''(x)                      & -0.136 & -2.3632 & \SetCell[c=1]{c, orange} -5.4768 & -1.2592 & 1.9904 \\[1em] \hline 
f'''(x)                      & -8.9088  & -21.3632 & 4.416 & 29.8688 & 12.9984 \\[1em] \hline 
f^{(iv)}(x)                  &-49.8176 & 53.2992 & 204.928 & 34.3296 & \SetCell[c=1]{c, orange} -67.4816 
\end{tblr}
\end{table}
...
\begin{align*}
    |E_T|&\approx\frac{5.4768}{12\times 4^2} & |E_S| &\approx \frac{67.4816}{180\times 4^4}\\[1em]
     &\approx 0.028525 & &\approx 0.00146444
\end{align*}
...
Vemos entonces, que para los datos dados, el método del trapecio resulta ser más eficaz que la regla de Simpson en este caso, al tener un error relativo menor. Esto contras con aproximacciones para el error obtenidas en el inciso anterior, la cuales sugieron lo contrario. Una posible explicación para esto, es que, al calcular has la cuarta derivada mediante diferencias finitas, en los puntos dados, los errores se acumulan, por lo que las cotas, en particular para la regla de Simpson, resulta no ser muy exacta.
